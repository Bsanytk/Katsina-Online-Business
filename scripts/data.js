...
(function(){
  window.DATA = {
    products: [
      { id: 'p1', title: 'Zane na mata (Dress)', price: 4500, category: 'Fashion', image: 'https://via.placeholder.com/400x300?text=Fashion+1', sellerId: 's1' },
      ...
      { id: 'p3', title: 'Kayan abinci - Tuwo', price: 500, category: 'Food', image: 'https://via.placeholder.com/400x300?text=Food+1', sellerId: 's3' }
    ],
    sellers: [
