...
const CONTACTS = [
  ...
  },
  {
    icon: <Icons.Email />,
    title: "Email Support",
    value: "support@katsinaonlinebusiness.com.ng",
    desc: "Detailed inquiries — response within 24 hours",
    href: "mailto:support@katsinaonlinebusiness.com.ng",
    bg: "bg-[#4B3621]/5",
    iconBg: "bg-[#4B3621]",
...
const SUPPORT_CATEGORIES = [
  {
    icon: "🛒",
    title: "Buyer Support",
    desc: "Order issues, payments, returns",
  },
  {
    icon: "🏪",
    title: "Seller Support",
    desc: "Listings, verification, KOB ID",
  },
  {
    icon: "🛡️",
    title: "Safety & Fraud",
    desc: "Report scams, suspicious activity",
  },
  {
    icon: "💳",
    title: "Account & Billing",
    desc: "Profile, settings, account issues",
  },
    ...
    <main className="min-h-screen bg-[#FAFAF8]">
      ...
      >
        ...
        >
          ...
          >
            Have a question, issue, or feedback? KOB Support is ready — choose
            your preferred contact method below.
          </p>
      ...
      >
        ...
        >
          <div>
            ...
            <h2
              className="text-xl font-black text-[#2C1F0E]
              mb-5"
            >
          ...
          <div>
            ...
            {/* Office info */}
            <div
              className="mt-5 p-4 bg-[#4B3621]/5
              border border-[#4B3621]/10 rounded-2xl"
            >
              <div className="flex items-start gap-3">
                <div
                  className="w-9 h-9 bg-[#4B3621] rounded-xl
