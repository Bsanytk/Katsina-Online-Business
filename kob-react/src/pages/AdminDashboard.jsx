...
function OverviewPanel({
  stats, sellers, orders, onRefreshOrders
}) {
    ...
    >
      {loading ? (
        <div className="flex items-center justify-center
          py-24 gap-3 text-xs text-gray-400">
          <svg className="animate-spin w-5 h-5
            text-[#4B3621]" fill="none" viewBox="0 0 24 24">
