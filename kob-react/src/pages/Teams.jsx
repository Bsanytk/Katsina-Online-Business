  ...
  return (
    <main className="min-h-screen bg-kob-light">
      ...
      <div className="container py-16 md:py-24">
        ...
        {/* Team Grid */}
        <div className="mb-20">
          <h3 className="text-3xl font-bold text-kob-dark mb-10 text-center">Meet the Team</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {teamMembers.map((member) => (
              <Card key={member.id} variant="elevated" className="p-8 rounded-xl text-center card-hover animate-fade-in">
                <div className="text-8xl mb-5 inline-block">{member.avatar}</div>
                <h3 className="text-xl font-bold text-kob-dark mb-2">{member.name}</h3>
                <p className="text-kob-primary font-bold text-base mb-4">{member.role}</p>
        ...
        {/* Values Section */}
        <div className="mb-20">
          <h3 className="text-3xl font-bold text-kob-dark mb-10 text-center">Our Core Values</h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card variant="elevated" className="p-8 rounded-xl card-hover">
              <div className="text-6xl mb-5 inline-block">🤝</div>
              <h3 className="text-2xl font-bold text-kob-dark mb-3">Trust & Transparency</h3>
            ...
            <Card variant="elevated" className="p-8 rounded-xl card-hover">
              <div className="text-6xl mb-5 inline-block">🚀</div>
              <h3 className="text-2xl font-bold text-kob-dark mb-3">Innovation</h3>
              <p className="text-gray-600 text-base leading-relaxed">
            ...
            <Card variant="elevated" className="p-8 rounded-xl card-hover">
              <div className="text-6xl mb-5 inline-block">💪</div>
              <h3 className="text-2xl font-bold text-kob-dark mb-3">Empowerment</h3>
              <p className="text-gray-600 text-base leading-relaxed">
        ...
        <div className="bg-gradient-to-br from-kob-primary via-kob-primary-light to-kob-gold text-white rounded-2xl p-12 md:p-16 shadow-lg">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-4xl md:text-5xl font-extrabold mb-6">Join Our Growing Team</h2>
            ...
            <div className="flex flex-col gap-5">
              <div className="bg-white bg-opacity-15 backdrop-blur-sm p-7 rounded-xl border border-white border-opacity-20 hover:bg-opacity-25 transition-all duration-300">
                <h3 className="text-2xl font-bold mb-3">🏍️ Riders & Delivery Partners</h3>
                <p className="text-base opacity-90 mb-5">Help deliver orders across Katsina and surrounding areas</p>
                <a
              ...
              <div className="bg-white bg-opacity-15 backdrop-blur-sm p-7 rounded-xl border border-white border-opacity-20 hover:bg-opacity-25 transition-all duration-300">
                ...
                <p className="text-base opacity-90 mb-5">Support sellers and expand KOB's presence locally</p>
                <a
                  href={t('seller.forms.rider_agent')}
                  target="_blank"
                  rel="noopener noreferrer"
