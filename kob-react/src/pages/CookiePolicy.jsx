    ...
    <main className="min-h-screen bg-kob-light">
      ...
      <div className="bg-gradient-to-r from-kob-primary to-kob-gold text-white py-16 md:py-20">
        <div className="container text-center">
          <h1 className="text-5xl md:text-6xl font-extrabold mb-4">{t('cookies.title')}</h1>
          <p className="text-lg opacity-90">{t('cookies.last_updated')}</p>
        </div>
      </div>

      <div className="container max-w-4xl py-16 md:py-24">
        {/* Intro Content */}
        <Card variant="default" className="p-8 md:p-10 rounded-2xl mb-8 bg-gradient-to-br from-blue-50 to-blue-100 border border-blue-200">
          <p className="text-lg text-blue-900 leading-relaxed">{t('cookies.intro')}</p>
        </Card>
                ...
                <div className="flex-1">
                  ...
                  {section.note && (
                    <div className="mt-4 p-4 bg-yellow-50 border-l-4 border-yellow-500 rounded">
                      <p className="text-yellow-900 font-medium text-sm">{section.note}</p>
                    </div>
                  )}
        ...
        <div className="mt-12 bg-gradient-to-br from-kob-primary via-kob-primary-light to-kob-gold text-white rounded-2xl p-12 text-center shadow-lg">
          <h2 className="text-4xl font-extrabold mb-4">Questions About Cookies?</h2>
          <p className="text-lg opacity-95 mb-8 font-light">We're here to help clarify any concerns about our cookie practices.</p>
          <a
        ...
        <Card variant="outlined" className="mt-12 p-6 rounded-lg bg-green-50 border-2 border-green-200">
          <p className="text-green-900 text-base">
            <strong>💡 Tip:</strong> You can always manage your cookie preferences through your browser settings. We recommend reviewing your browser's privacy settings regularly to maintain your desired level of control.
          </p>
        </Card>
      </div>
    </main>
