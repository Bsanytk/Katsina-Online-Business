      ...
      <div className="pl-5 pr-5 py-4">
        <div className="flex items-start gap-3.5">
          ...
          <div className="flex-1 space-y-2">
            <div className="h-3.5 bg-gray-200 rounded-lg
              animate-pulse w-3/4" />
...
function EmptyState() {
  return (
    <div className="flex flex-col items-center
      ...
      <div className="w-20 h-20 bg-[#4B3621]/5 rounded-3xl
      ...
      <p className="text-xs text-gray-400 max-w-xs
        leading-relaxed">
        You're all caught up! Important announcements,
        updates, and delivery alerts will appear here.
      </p>
    </div>
  )
}
...
export default function Alerts() {
  ...
  return (
    <main className="min-h-screen bg-[#F9F9F7]">
      ...
      {/* HEADER                           */}
      {/* ================================ */}
      <div className="sticky top-0 z-30 bg-[#F9F9F7]/95
        ...
        <div className="max-w-xl mx-auto px-4 py-4
          ...
          <div className="flex-1 min-w-0">
            <h1 className="text-base font-bold text-[#2D1E17]">
              Alerts
            </h1>
