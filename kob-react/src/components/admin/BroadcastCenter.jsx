    ...
    <div className="space-y-5 max-w-2xl">
      ...
      <div className="p-4 bg-blue-50 border border-blue-100
        ...
        <p className="text-xs text-blue-700 font-medium
          leading-relaxed">
          ℹ️ Broadcasts are saved to Firestore.
          To send actual push notifications, enable
          Firebase Cloud Messaging in your Firebase Console
          and add a Cloud Function trigger on the
          <code className="mx-1 px-1.5 py-0.5 bg-blue-100
      ...
      <div className="bg-white rounded-2xl border
        ...
        <form onSubmit={handleSend} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={
              sending || !form.title.trim() || !form.body.trim()
            }
