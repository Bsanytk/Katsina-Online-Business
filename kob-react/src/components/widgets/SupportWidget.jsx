...
export default function SupportWidget() {
  ...
  const faqs = [
    {
      ...
      answer:
        ...
        'Click the "Register" button and fill in your details. You\'ll receive a verification email to confirm your account.',
    },
    {
      id: 2,
      ...
      answer:
        ...
        'Navigate to your Seller Dashboard and click "Add Product". Fill in the details, upload images, and set your price. Your product will be live immediately.',
    },
    {
      id: 3,
      ...
      answer:
        ...
        "We offer free product listings for all sellers. Check our Verified Sellers Program for special benefits.",
    },
    {
      id: 4,
      ...
      answer:
        ...
        "We support secure payments. All transactions are protected, and funds are handled securely.",
    },
    {
      id: 5,
      ...
      answer:
        ...
        "Yes! You can edit or delete your listings anytime from your Dashboard. Changes take effect immediately.",
    },
    {
      id: 6,
      question:
        t("faq.items.5.question") || "What if I have an issue with an order?",
      answer:
        t("faq.items.5.answer") ||
        "Contact our support team through the Help Center or WhatsApp. We're available 9AM-5PM WAT.",
    },
  ];
  ...
  const shouldHide = hiddenPages.some(
          ...
          >
            ...
            <div className="bg-gradient-to-r from-kob-primary to-kob-gold text-white p-4 rounded-t-lg flex-shrink-0">
              ...
              <p className="text-xs opacity-90">
                {t("supportWidget.availableHours")}
              </p>
            </div>
                ...
                <div className="space-y-2">
                  ...
                  >
                    <span className="font-semibold text-orange-900">
                      ❓ {t("supportWidget.faqTitle")}
                    </span>
                    <p className="text-xs text-orange-700 mt-1">
                      {t("supportWidget.allFaq")}
                    </p>
                  </button>
                  ...
                  >
                    <span className="font-semibold text-indigo-900">
                      📝 {t("supportWidget.contactTitle")}
                    </span>
                    <p className="text-xs text-indigo-700 mt-1">
                      {t("supportWidget.allHelp")}
                    </p>
                  </button>
                </div>
              )}
